...
const INVITATION = {
  ...
  date: {
    ...
    displayLong: "සෙනසුරාදා, 15 අගෝස්තු 2026",
    countdownTarget: "2026-08-15T08:30:00+05:30",
  },
  time: {
    start: "පෙ.ව. 8:00",
    ceremonyStart: "පෙ.ව. 8:30",
    ceremonyEnd: "ප.ව. 4:00",
    registration: "පෙ.ව. 10:45",
    welcome: "දහවල් 12:30",
  },
  venue: {
    name: "රොක් හිල් හෝටලේ",
    city: "හෝමාගම",
    mapQuery: "Rock Hill Hotel, Homagama",
    googleMapsLink: "https://share.google/ajYvlzGaTX4191dxy",
  },
  rsvpContacts: ["අකලංක: 075-9811276", "අනුරාධා: 077-4407975"],
} as const;

const backgroundMusic = "/Oba_Wenuwen_Gayan_Gunawardana_Sarigama_lk.mp3";
const googleScriptUrl =
  "https://script.google.com/macros/s/AKfycbzC_f0YV3GHliOPzEymWeAiTYnEoDIQzCRRmNME1MEDeXMsA7CM3vS9hxUeHIinvrEfQA/exec";

const HERO_BACKGROUND_IMAGE = "/ChatGPT Image Jul 1, 2026, 01_53_25 PM.png";
const DETAILS_BACKGROUND_IMAGE = "/ChatGPT Image Jul 1, 2026, 01_58_23 PM.png";
const TIMELINE_BACKGROUND_IMAGE = "/ChatGPT Image Jul 1, 2026, 01_58_23 PM.png";
const WISHES_BACKGROUND_IMAGE = "/ChatGPT Image Jul 1, 2026, 01_58_23 PM.png";
          ...
          >
            ...
            <section className="w-full relative flex items-start justify-center overflow-hidden bg-white min-h-[85vh] pt-20 md:pt-32">
              ...
              <div className="relative z-10 w-full max-w-5xl px-6 text-center">
                ...
                >
                  අපේ මගුල් ගෙදර ඇවිත් යන්න එන්න
                </motion.p>
                ...
                <motion.div
                  ...
                  className="mt-8 md:mt-10 flex flex-row items-center justify-center gap-2 sm:gap-4 md:gap-5"
                >
                  <h1 className="text-[1.75rem] sm:text-6xl md:text-8xl text-[#0369a1] italic leading-none drop-shadow-[0_0_15px_rgba(255,255,255,0.9)] whitespace-nowrap">
                    {INVITATION.couple.bride}
                  </h1>

                  <div className="flex items-center justify-center gap-1 sm:gap-5">
                    <div className="hidden sm:block h-px w-8 md:w-14 bg-[#0369a1]/40" />
                    <span className="text-xl sm:text-4xl md:text-5xl text-[#0369a1] drop-shadow-[0_0_8px_rgba(255,255,255,0.8)] font-bold whitespace-nowrap">සහ</span>
                    <div className="hidden sm:block h-px w-8 md:w-14 bg-[#0369a1]/40" />
                  </div>
                ...
                <motion.div
                  ...
                  className="mt-64 sm:mt-72 md:mt-12 space-y-5"
                >
                  <p className="text-sm sm:text-base md:text-xl tracking-[0.15em] sm:tracking-[0.25em] text-[#0369a1] font-bold drop-shadow-[0_0_8px_rgba(255,255,255,0.8)]">
                    {INVITATION.date.displayLong} · {INVITATION.time.start}
                  </p>
                ...
                >
                  ...
                  <div className="text-[#0369a1] space-y-4">
                    <div className="space-y-4 mb-8">
                      <h2 className="text-3xl md:text-5xl text-[#0284c7] font-bold mb-8 drop-shadow-sm">
                        ශ්‍රී සුභ මංගලම්
                      </h2>
                      ...
                      <div className="flex flex-col items-center justify-center gap-2">
                        <span className="text-sm md:text-base tracking-wider text-slate-700">
                          ආනන්ද මැතිතුමාගේ සහ ශ්‍යාමලී මැතිනියගේ ආදරණීය දියණිය
                        </span>
                        ...
                        <span className="text-sm md:text-base tracking-wider text-slate-700">
                          ආරියදාස මැතිතුමාගේ සහ රංජනී මැතිනියගේ ආදරණීය පුත්
                        </span>
                        <span className="text-xl md:text-2xl font-bold text-[#0284c7] my-1">
                  ...
                  >
                    ...
                    <div className="mt-12 grid grid-cols-1 gap-6 w-full text-left">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <div className="text-[10px] md:text-xs tracking-[0.4em] font-bold text-white bg-[#0369a1] px-3 py-1 rounded-full inline-block mb-1 shadow-sm">
                            දිනය
                          </div>
              ...
              <div className="container mx-auto px-6 max-w-5xl relative z-10 text-center">
                ...
                <div className="mx-auto max-w-2xl w-full text-left bg-white border border-[#7dd3fc]/40 shadow-[0_30px_70px_-20px_rgba(45,90,39,0.1)] rounded-[2rem]">
                  <div className="p-8 md:p-12 space-y-8">
                    {[
                      ["උත්සවය ආරම්භය", INVITATION.time.start],
                      ["පෝරුවේ චාරිත්‍ර", INVITATION.time.ceremonyStart],
                      ...
                      <div key={title} className="flex items-start gap-4">
                        ...
                        <div>
                          <div className="text-[10px] md:text-xs tracking-widest font-bold text-white bg-[#0369a1] px-3 py-1 rounded-full inline-block mb-1 shadow-sm">
                            {title}
                          </div>
              ...
              <section className="w-full relative overflow-hidden py-24 md:py-32 bg-white">
                ...
                <div className="container mx-auto px-6 max-w-5xl text-center relative z-10">
                  ...
                  >
                    ...
                    <p className="text-[8px] md:text-[10px] tracking-[0.2em] text-[#0369a1]/40 font-bold mt-2">
